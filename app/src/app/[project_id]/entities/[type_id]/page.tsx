...
const EntitiesTypePage: React.FC = () => {
  const params = useParams();
  const projectId = params.project_id as string;
  const typeId = params.type_id as string;
  const timelineId = useGraphStore.getState().currentTimelineId;
    ...
    <DashboardLayout projectsSidebar={projectsSidebar}>
      ...
      <CreateTeamModal
        ...
        onSuccess={() => {
          ...
          console.log('Team created successfully from type page');
        }}
      />
    </DashboardLayout>
  );
...
export default EntitiesTypePage;
