...
describe('ConditionEvaluator', () => {
  ...
  describe('evaluateCondition', () => {
    ...
    it('should evaluate variable comparison conditions correctly', () => {
      ...
      // Проверяем сравнение переменных
      const compareVariablesCondition: Condition = {
        id: '7',
        type: ConditionType.VARIABLE_COMPARISON,
        varId: 'score',
        valType: 'variable',
      ...
      expect(evaluator.evaluateCondition(compareVariablesCondition, gameState)).toBe(true);

      // Проверяем процентные переменные
      const percentCondition: Condition = {
        id: '8',
        type: ConditionType.VARIABLE_COMPARISON,
        varId: 'percentage',
        valType: 'custom',
      ...
      expect(evaluator.evaluateCondition(percentCondition, gameState)).toBe(true);
    });
